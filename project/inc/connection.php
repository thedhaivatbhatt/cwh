...
define("FILENAME",$_SERVER['DOCUMENT_ROOT']."/cwh/project/admin/inc/error.log");
define("ISDEBUG",true);
define("SERVER","localhost:3306");
define("USERNAME","root");
define("PASSWORD","");
define("DATABASE","advertise");
...
function LogError(PDOException $error,$FileName='connection.php',$line=0) //user defined functions
{
    ...
    {
        $ErrorMessage = "oops, something went wrong, we are trying to findout the problem. please come after sometime";
        $_SESSION['error'] = $ErrorMessage;
        //echo $ErrorMessage;
    }
}
