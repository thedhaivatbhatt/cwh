...
if ($validation->fails()) {
    ...
    $_SESSION['errors'] = serialize($errors->firstOfAll()); //create global array errors which has all errors
    header("Location:../input2_2.php"); //forcefully send user on other page
    exit;
} else {
